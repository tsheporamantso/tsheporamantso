...
const techStack = {
  ...
  tools:    ["Docker", "Git & Git flow", "JSDoc (JS type annotations & documentation generation)"],
};
```
---
...
- Currently levelling up in Three.js, Docker and Kubernetes to bring more depth to the frontend work I do
...
- 💼 LinkedIn: [linkedin.com/in/gladwinramantso](https://www.linkedin.com/in/gladwinramantso/)
